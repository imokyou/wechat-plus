...
import (
	...
	"github.com/imokyou/wechat-plus/v2/officialaccount/datacube"

	"github.com/imokyou/wechat-plus/v2/credential"
	"github.com/imokyou/wechat-plus/v2/officialaccount/basic"
	"github.com/imokyou/wechat-plus/v2/officialaccount/broadcast"
	"github.com/imokyou/wechat-plus/v2/officialaccount/config"
	"github.com/imokyou/wechat-plus/v2/officialaccount/context"
	"github.com/imokyou/wechat-plus/v2/officialaccount/device"
	"github.com/imokyou/wechat-plus/v2/officialaccount/js"
	"github.com/imokyou/wechat-plus/v2/officialaccount/material"
	"github.com/imokyou/wechat-plus/v2/officialaccount/menu"
	"github.com/imokyou/wechat-plus/v2/officialaccount/message"
	"github.com/imokyou/wechat-plus/v2/officialaccount/oauth"
	"github.com/imokyou/wechat-plus/v2/officialaccount/server"
	"github.com/imokyou/wechat-plus/v2/officialaccount/user"
)
